...
(function () {
  ...
  function onSaveButtonClick() {
    ...
    function createEditCard() {
      ...
      cardElement.querySelector('.edit__photo-label').setAttribute('for', 'photo-1' + number.toString);
      cardElement.querySelector('.edit__checkbox-input').id = 'checkbox-1' + number.toString;
      cardElement.querySelector('.edit__checkbox-input').name = 'checkbox-1' + number.toString;
      cardElement.querySelector('.edit__checkbox-label').setAttribute('for', 'checkbox-1' + number.toString);
      return cardElement;
    }
