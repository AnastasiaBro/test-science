...
(function () {
  ...
  function onSaveButtonClick() {
    ...
    function createEditCard() {
      ...
      cardElement.querySelector('.edit__photo-label').setAttribute('for', 'photo-' + (rows.length + 1));
      ...
      cardElement.querySelector('.edit__checkbox-label').setAttribute('for', 'checkbox-' + (rows.length + 1));
      return cardElement;
    }
