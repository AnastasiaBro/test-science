...
(function () {
  ...
  function onSaveButtonClick() {
    ...
    function createEditCard() {
      ...
      cardElement.querySelector('.edit__photo-input').id = 'photo-1' + (rows.length + 1);
      cardElement.querySelector('.edit__photo-input').name = 'photo-1' + (rows.length + 1);
      cardElement.querySelector('.edit__photo-label').setAttribute('for', 'photo-1' + (rows.length + 1));
      cardElement.querySelector('.edit__checkbox-input').id = 'checkbox-1' + (rows.length + 1);
      cardElement.querySelector('.edit__checkbox-input').name = 'checkbox-1' + (rows.length + 1);
      cardElement.querySelector('.edit__checkbox-label').setAttribute('for', 'checkbox-1' + (rows.length + 1));
      return cardElement;
    }
